            ...
            <div onTouchStart={handleTouchStart}
                ...
                <div className="content-hero relative w-full h-screen">
                    ...
                    <div key={currentIndex} className="relative w-full h-screen px-6 md:px-12">
                        ...
                        <div className="main-content w-full h-2/3 flex flex-col justify-center">
                            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-bold text-white animate-slide delay-200">{currentMovie?.title?.toUpperCase() || currentMovie?.name?.toUpperCase()}</h1>
