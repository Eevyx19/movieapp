...
const Popular = ({ popular, loading, type }) => {
                        ...
                        popular.map((item, index) => {
                            return (
                                <div
                                    ...
                                    className="group w-30 2xs:w-35 4xs:w-40 md:w-50 lg:w-60 shrink-0 relative bg-gray-900 rounded-xl overflow-hidden cursor-pointer transform transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:scale-105 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/50 active:scale-95"
                                >
